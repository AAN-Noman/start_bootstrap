    ...
    <div class="container">
        <div class='row'>
            <div class="col-md-12 ">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Service Edit <a href="{{ route('backend.services.index') }}" class="btn btn-primary btn-sm">All Service</a></h2>
                    ...
                    <div class="x_content">
                        ...
                        <form action="#" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="form-group row ">
                                <label class="control-label col-md-3 col-sm-3 ">Service Title</label>
                                <div class="col-md-9 col-sm-9 ">
                                    <input type="text" class="form-control" placeholder="Service Title" name="title" value="{{$services->title}}">
                                </div>
                            </div>
                            <div class="form-group row">
