...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="navbar-brand" href="{{ route('frontend.home') }}" target="_blank"><img
                    src="{{ asset('frontend/assets/img/navbar-logo.svg') }}" alt="{{ config('app.name') }}" /></a>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ route('backend.services.create') }}">Add Service</a>
                        <a class="collapse-item" href="{{ route("backend.services.index") }}">All Service</a>
                    </div>
                    <div class="bg-white py-2 collapse-inner rounded">
